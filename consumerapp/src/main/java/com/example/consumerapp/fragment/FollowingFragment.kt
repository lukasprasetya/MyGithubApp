...
import com.example.consumerapp.model.*
...
class FollowingFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (favorites != null){
            ...
            followingViewModel.setListUserFollowing(activity!!.applicationContext, dataFavorite.username.toString())
            showLoading(true)
        }else {
            dataUser = activity!!.intent.getParcelableExtra(EXTRA_USER) as User


            followingViewModel.setListUserFollowing(activity!!.applicationContext, dataUser.username.toString())
            showLoading(true)
        }
