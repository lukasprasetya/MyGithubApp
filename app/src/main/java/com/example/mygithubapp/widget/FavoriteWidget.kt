...
class FavoriteWidget : AppWidgetProvider() {
    ...
    companion object {
        ...
        private fun updateAppWidget(
            ...
            views.setRemoteAdapter(R.id.sv_favWidget, intent)
            views.setEmptyView(R.id.sv_favWidget, R.id.empty_view)
            ...
            views.setPendingIntentTemplate(R.id.sv_favWidget, toastPendingIntent)
