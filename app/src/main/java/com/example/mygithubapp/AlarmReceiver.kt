...
class AlarmReceiver : BroadcastReceiver() {
    ...
    companion object {
        ...
        private const val TIME_REPEATING = "13:03"
    }
    ...
    private fun showAlarmNotification(context: Context, message: String?) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            notificatioManagerCompat.createNotificationChannel(channel)
        }

        val notification = builder.build()
        notificatioManagerCompat.notify(100, notification)
    }
    ...
    fun cancelAlarm(context: Context){
        ...
        Toast.makeText(context, "Alarm Reminder Canceled", Toast.LENGTH_SHORT).show()
    }
}